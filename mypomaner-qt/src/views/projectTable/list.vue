  ...
  <div class="container">
    <lay-row space="10">
      <lay-col md="14">
        ...
        <lay-form-item label="项目编码" mode="inline">
        ...
        <lay-form-item label="类名称" mode="inline">
          <lay-input v-model="searchDto.codeName" @change="loadData"/>
        </lay-form-item>
        <lay-form-item label="创建人" mode="inline">
          <lay-input v-model="createName"/>
        </lay-form-item>
      </lay-col>
      <lay-col md="10">
...
onMounted(() => {
  ...
  createName.value = route.query.createName
