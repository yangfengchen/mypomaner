...
public class EntityGenterTest {
    public static void main(String[] args) {
        String url = "jdbc:mysql://localhost:3306/mypomaner?useUnicode=true&characterEncodidng=utf-8&allowMultiQueries=true";
        String outPath = "/Users/zz/Documents/temp/mypomaner";
        FastAutoGenerator.create(url, "root", "root123!@#")
                ...
                .packageConfig(builder -> {
                    builder.parent("com.ddzj.mypomaner") // 设置父包名
